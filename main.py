...
## Classe "Vacances", qui s'occupera de réaliser l'intégralité du code
class Vacances():
    ...
    def __init__(self):
        ...
        #self.hiver = self.det_vac(['2024-02-24:','2024-03-04:'])       #Ces lignes sont mises en commentaires car l'emploi du temps actuel n'est pas complet, ainsi le code ne pourra pas
        #self.printemps = self.det_vac(['2024-04-13:','2024-04-29:'])   #trouver les dates correctement et génèrera une erreur
